  ...
  <div class="box-share-users">
    ...
    ?>
        <div class="grid-share grid-users">
            <a style="position: relative; z-index: 999999; color: black" href="<?php echo BASE_URL . $u->username; ?>" onclick="window.location = '<?php echo BASE_URL . $u->username; ?>'">
                <img src="assets/images/users/<?php echo $u->img; ?>" alt="" class="img-share" />
            </a>
            <div>
                <p>
                    <a onclick="window.location = '<?php echo BASE_URL . $u->username; ?>'" style="color: black" href="<?php echo BASE_URL . $u->username; ?>">
            ...
            <div>
                <?php if ($u->id !== $user_id) { ?>
                    <button class="follow-btn follow-btn-m <?= $user_follow ? 'following' : 'follow' ?>" data-follow="<?php echo $user->user_id; ?>" data-user="<?php echo $user_id; ?>" data-profile="<?php echo $u_id; ?>">
